...
exports.matchingPrompt = exports.researchPrompt = void 0;
// ─── Research Agent ──────────────────────────────────────────────────────
function researchPrompt(company, vibe, filters) {
...
// ─── Matching Agent ──────────────────────────────────────────────────────
function matchingPrompt(listing, resumeSummary, dealbreakers, vibe, candidateYoE) {
    return `
...
exports.matchingPrompt = matchingPrompt;
